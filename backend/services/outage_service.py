            ...
            if outage.asset:
                feature = OutageFeature(
                    ...
                    properties=OutageFeatureProperties(
                        ...
                        outage_type=outage.outage_type.value if hasattr(outage.outage_type, 'value') else outage.outage_type,
                        status=outage.status.value if hasattr(outage.status, 'value') else outage.status,
                        ...
                        fuel_type=outage.asset.fuel_type.value if hasattr(outage.asset.fuel_type, 'value') else outage.asset.fuel_type,
